...
if (isset($_POST['add'])) {
  ...
  $sql = "INSERT INTO property (title, pcontent, bhk, type_id, bedroom, bathroom, balcony, kitchen, hall, floor, size, price, feature, pimage, pimage1, pimage2, pimage3, pimage4, uid, status, mapimage, topmapimage, groundmapimage, totalfloor, date, cate_id, province_id, district_id, wards_id)
  VALUES (:title, :content, :bhk, :typehouse, :bed, :bath, :balc, :kitc, :hall, :floor, :asize, :price, :feature, :aimage, :aimage1, :aimage2, :aimage3, :aimage4, :uid, :status, :fimage, :fimage1, :fimage2, :totalfloor, NOW(), :category, :province, :district, :wards)";
