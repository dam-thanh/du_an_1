      ...
      <div class="full-row">
        <div class="container">
          <div class="row">
            ...
            <?php
            $pid = $_REQUEST['pid'];
            $query = $con->prepare("SELECT property.*, user.*, typehouse.type_name ,wards.wards_name ,district.district_name,province.province_name, categories.cate_name
                       FROM property
                       ...
                       INNER JOIN categories ON property.cate_id = categories.cate_id
              ...
              <div class="col-lg-8">
                  ...
                  <div class="col-md-12">
                    <div id="single-property" style="width:1200px; height:700px; margin:30px auto 50px;">
                      ...
                      <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;">
                        <img width="1920" height="1080" src="admin/property/<?php echo $row['pimage']; ?>" class="ls-bg" alt="" />
                      </div>

                      <!-- Slide 2-->
                      <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;">
                        <img width="1920" height="1080" src="admin/property/<?php echo $row['pimage1']; ?>" class="ls-bg" alt="" />
                      </div>

                      <!-- Slide 3-->
                      <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;">
                        <img width="1920" height="1080" src="admin/property/<?php echo $row['pimage2']; ?>" class="ls-bg" alt="" />
                      </div>

                      <!-- Slide 4-->
                      <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;">
                        <img width="1920" height="1080" src="admin/property/<?php echo $row['pimage3']; ?>" class="ls-bg" alt="" />
                      </div>

                      <!-- Slide 5-->
                      <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;">
                        <img width="1920" height="1080" src="admin/property/<?php echo $row['pimage4']; ?>" class="ls-bg" alt="" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="property-details">
                  <div class="bg-gray property-quantity px-4 pt-4 w-100">
                    <ul>
                      <li><span class="text-secondary"><?php echo $row['size']; ?></span> m <sup>2</sup></li>
                      ...
                      <li><span class="text-secondary"><?php echo $row['hall']; ?></span> Sảnh</li>
                      <li><span class="text-secondary"><?php echo $row['kitchen']; ?></span> Phòng bếp</li>
                    </ul>
                  </div>
                    ...
                    <table class="w-100">
                      <tbody>
                        <tr>
                          ...
                          <td>Property Type :</td>
                          <td class="text-capitalize"><?php echo $row['cate_name']; ?></td>
                        </tr>
                        <tr>
                          <td>Floor :</td>
                        ...
                        <tr>
                          <td>province :</td>
                          <td class="text-capitalize"><?php echo $row['province_name']; ?></td>
                          <td>Quận/Huyện :</td>
                          <td class="text-capitalize"><?php echo $row['district_name']; ?></td>
                        </tr>
                  ...
                  <div class="accordion" id="accordionExample">
                    ...
                    <div id="collapseOne" class="collapse show p-4" aria-labelledby="headingOne" data-parent="#accordionExample">
                      <img src="admin/property/<?php echo $row['mapimage']; ?>" alt="Not Available">
                    </div>
                    ...
                    <div id="collapseTwo" class="collapse p-4" aria-labelledby="headingTwo" data-parent="#accordionExample">
                      <img src="admin/property/<?php echo $row['topmapimage']; ?>" alt="Not Available">
                    </div>
                    ...
                    <div id="collapseThree" class="collapse p-4" aria-labelledby="headingThree" data-parent="#accordionExample">
                      <img src="admin/property/<?php echo $row['groundmapimage']; ?>" alt="Not Available">
                    </div>
                  </div>
            ...
            <div class="col-lg-4">
              ...
              <ul class="property_list_widget">
                ...
                <?php
                $query = $con->prepare("SELECT * FROM property WHERE isFeatured = 1 ORDER BY date DESC LIMIT 3");
                $query->execute();
              ...
              <div class="sidebar-widget mt-5">
                ...
                <ul class="property_list_widget">
                  ...
                  <?php
                  $query = $con->prepare("SELECT * FROM property
                          INNER JOIN wards ON property.wards_id = wards.wards_id
            INNER JOIN district ON property.district_id = district.district_id
            INNER JOIN province ON property.province_id = province.province_id
