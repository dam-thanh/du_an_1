          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="dash-widget-info">
                ...
                <h3><?php $sql = "SELECT * FROM categories where cate_name = 'Căn hộ'";
                    $query = $con->query($sql);
                    echo "$query->num_rows"; ?></h3>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="dash-widget-info">
                ...
                <h3><?php $sql = "SELECT * FROM property where type_id = 2";
                    $query = $con->query($sql);
                    echo "$query->num_rows"; ?></h3>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="dash-widget-info">
                ...
                <h3><?php $sql = "SELECT * FROM property where type_id = 1";
