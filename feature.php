        ...
        <div class="container">
          ...
          <table class="items-list col-lg-12 table-hover" style="border-collapse:inherit;">
            ...
            <tbody>
              ...
              JOIN wards ON property.wards_id = wards.wards_id
              ...
              ?>
                <tr>
                  ...
                  <td class="text-capitalize"><?php echo $row['type_name']; ?></td>
                  <td><?php echo $row['date']; ?></td>
                  <td class="text-capitalize"><?php echo $row['status']; ?></td>
                  <td><a class="btn btn-info" href="submitpropertyupdate.php?pid=<?php echo $row['pid']; ?>">Update</a>
                  </td>
                  <td><a class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" href="submitpropertydelete.php?id=<?php echo $row['pid']; ?>">Delete</a>
                  </td>
                </tr>
              <?php } ?>
              <!-- FOR MORE PROJECTS visit: codeastro.com -->
